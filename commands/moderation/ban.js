...
return message.channel.send('<:HBminus:783351288515657728> | I need the Ban Members permission.');

let perms = message.member.hasPermission("BAN_MEMBERS"); 
if(!perms) return message.channel.send("<:HBminus:783351288515657728> | You do not have Permissions to use this command.");
