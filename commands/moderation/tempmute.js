...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!message.member.permissions.has("MUTE_MEMBERS")) return message.channel.send("<:HBminus:783351288515657728> | I'm sorry, but you don't have the necessary permissions to use that command.");

    if(!message.guild.me.permissions.has("MUTE_MEMBERS", "MANAGE_ROLES")) 
    return message.channel.send('<:HBminus:783351288515657728> | I need the Mute Members and Manage Roles permission.'); 
